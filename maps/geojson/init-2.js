			...
			success: function load(d) {	
				...
				var heatmap =  L.geoJson(density, {
					style: function(feature) {
						...
						if(densidad > -1    && densidad < 1000)  return { opacity: 0.8, weight: 1, color: "#ffebd6" };
						if(densidad > 999   && densidad < 2000)  return { opacity: 0.8, weight: 1, color: "#f5cbae" };
						if(densidad > 1999  && densidad < 5000)  return { opacity: 0.8, weight: 1, color: "#eba988" };
						if(densidad > 4999  && densidad < 10000) return { opacity: 0.8, weight: 1, color: "#e08465" };
						if(densidad > 9999  && densidad < 20000) return { opacity: 0.8, weight: 1, color: "#d65d45" };
						if(densidad > 19999 && densidad < 30000) return { opacity: 0.8, weight: 1, color: "#cc3527" };
						if(densidad > 29999) return { opacity: 0.8, weight: 1, color: "#c40a0a" };
					}
				});
